...
class ColdStartRecoveryTests(unittest.TestCase):
    def test_repository_only_reconstruction_recovers_required_state(self):
        ...
        self.assertEqual(snapshot["branch"], "team/g2b-task9-prebootstrap-gate-20260907")
        self.assertEqual(snapshot["pull_request"], 56)
        self.assertEqual(snapshot["pull_request_state"], "DRAFT_DO_NOT_MERGE_WAITING_HUMAN_GATE")
        ...
        self.assertEqual(snapshot["tasks_8_10"], "TASK_8_COMPLETE_TASK_9_WAITING_HUMAN_GATE_TASK_10_NOT_STARTED")
        self.assertEqual(snapshot["f1_2c"], "ISOLATED_DO_NOT_MODIFY")
        self.assertEqual(snapshot["node01_g2b_gate"], "CLOSED_NOT_AUTHORIZED_WAITING_HUMAN_REVIEW")
        ...
        self.assertEqual(snapshot["merge_gate"], "CLOSED_NOT_AUTHORIZED_TASK9_DRAFT")
