...
class ColdStartRecoveryTests(unittest.TestCase):
    def test_repository_only_reconstruction_recovers_required_state(self):
        ...
        self.assertEqual(snapshot["tasks_8_10"], "TASK_8_BLOCKED_EXTERNAL_TASKS_9_10_NOT_STARTED")
        ...
        self.assertEqual(snapshot["merge_gate"], "AUTHORIZED_POST_ACCEPTANCE_NOT_YET_ELIGIBLE")
