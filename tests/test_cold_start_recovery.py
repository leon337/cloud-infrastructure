...
class ColdStartRecoveryTests(unittest.TestCase):
    def test_repository_only_reconstruction_recovers_required_state(self):
        ...
        self.assertEqual(snapshot["branch"], "codex/context-bridge-reconcile-20260823")
        self.assertIsNone(snapshot["pull_request"])
        self.assertEqual(snapshot["pull_request_state"], "LOCAL_ONLY_NO_PUSH")
        ...
        self.assertEqual(snapshot["tasks_8_10"], "TASK_8_LAB_PASS_TASKS_9_10_NOT_STARTED")
        ...
        self.assertEqual(snapshot["merge_gate"], "CLOSED_NOT_AUTHORIZED_LOCAL_CANDIDATE_REVIEW_REQUIRED")
