...
- RUNNER-ISOLATION-P1: `CROSS_JOB_ISOLATION_VERIFIED_GLOBAL_HOOK_ACTIVE_VERIFIED`; PoC legado retirado; restart ocorreu em 02/09 e o probe pós-restart `33992772737` confirmou hooks carregados, porém rejeitados pelo runner por path extensionless. Wrapper `.sh` ativado live em 05/09; run `33998487949` confirmou STARTED/COMPLETED com `RUNNER_ISOLATION_GUARD_PASS` e prova cross-job PASS. PR #47 foi integrado em `main@65717400a1c976f0d8a634411b69515519dd87cb`; `runner_isolation.next_exact_step=NONE`.
