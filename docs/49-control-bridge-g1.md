...
O status do runner é observado na GitHub API, não prova VPS fresca. F1.2c
mantém os fatos/timestamps próprios e sua branch está congelada para Codex;
G2-B permanece fail-closed em `state/control-bridge-g2b.yaml`.
