...
O próximo passo histórico acima foi satisfeito pelo design G2-B aprovado; a
implementação continua pendente e fail-closed em `state/control-bridge-g2b.yaml`.
...
fatos/timestamps e sua branch está congelada para Codex.
