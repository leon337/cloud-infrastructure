...
descartável `32100527131`; esses serviços ainda não foram aplicados no NODE-01.
...
O próximo delta precisa transformar os artefatos validados em desired state
bounded para o NODE-01, com precheck, rollback e evidência. O primeiro workload
continua bloqueado por esse apply e pelos gates restantes de quota/admission.
