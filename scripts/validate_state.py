...
def main() -> int:
    ...
    exact = {
        ...
        ("documentation_state",): "PRE_REBOOT_OFFHOST_RECOVERY_FRESH_EXTERNAL_COORDINATION_PENDING",
        ...
        ("project", "next_exact_step"): "PRE_REBOOT_EXTERNAL_SERVICE_COORDINATION_GATE",
        ...
        ("pre_reboot_checkpoint", "blocking_reason"): "EXTERNAL_SERVICE_COORDINATION_PENDING",
        ...
        ("reboot_coordination", "status"): "BLOCKED_EXTERNAL_SERVICE_COORDINATION_AND_HUMAN_GATE",
