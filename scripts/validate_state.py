...
def main() -> int:
    ...
    exact = {
        ...
        ("documentation_state",): "POST_REBOOT_INTEGRATION_COMPLETE_BRANCH_HYGIENE_NEXT",
        ...
        ("project", "status"): "ACTIVE_POST_REBOOT_INTEGRATION_COMPLETE",
        ("project", "next_exact_step"): "CANONICAL_PR_BRANCH_HYGIENE",
