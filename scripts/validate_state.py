...
def main() -> int:
    ...
    exact = {
        ...
        ("project", "next_exact_step"): "F1_2C_NODE01_ROLLOUT_HUMAN_GATE",
        ("runner_isolation", "status"): "CROSS_JOB_ISOLATION_VERIFIED_GLOBAL_HOOK_EXTENSION_REMEDIATION_REQUIRED",
        ...
        ("runner_isolation", "global_hook"): "LOADED_REJECTED_INVALID_SCRIPT_EXTENSION",
        ("runner_isolation", "global_hook_restart_required"): True,
        ("runner_isolation", "global_hook_activation_authorized"): False,
        ("runner_isolation", "global_hook_last_probe_run"): 33992772737,
        ("runner_isolation", "global_hook_last_probe_result"): "FAIL_INVALID_SCRIPT_EXTENSION",
        ("runner_isolation", "global_hook_remediation_candidate"): "config/runner/cloud-infrastructure-runner-isolation-guard.sh",
        ("runner_isolation", "next_exact_step"): "RUNNER_ISOLATION_GLOBAL_HOOK_ACTIVATION_HUMAN_GATE",
