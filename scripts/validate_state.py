...
def main() -> int:
    ...
    exact = {
        ...
        ("documentation_state",): "POST_REBOOT_PR51_INTEGRATED_PR50_CANONICAL_MERGE_PENDING",
        ...
        ("project", "integration_status"): "PR51_OPERATIONAL_FIX_INTEGRATED_PR50_CANONICAL_MERGE_PENDING",
        ("project", "next_exact_step"): "HUMAN_GATE_PR50_CANONICAL_MERGE",
        ...
        ("post_reboot_integration", "status"): "PR51_OPERATIONAL_FIX_INTEGRATED_PR50_CANONICAL_MERGE_PENDING",
        ...
        ("post_reboot_integration", "canonical_reconciliation", "merge_status"): "NOT_AUTHORIZED_HUMAN_GATE_REQUIRED",
        ...
        ("authorization", "post_reboot_integration"): "PR51_OPERATIONAL_INTEGRATION_COMPLETED",
        ("authorization", "pr50_canonical_merge"): "NOT_AUTHORIZED_HUMAN_GATE_REQUIRED",
