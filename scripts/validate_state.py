...
def main() -> int:
    ...
    exact = {
        ...
        ("documentation_state",): "PRE_REBOOT_CHECKPOINT_RECONCILED_OFFHOST_FRESHNESS_GAP",
        ...
        ("project", "next_exact_step"): "PRE_REBOOT_OFFHOST_RECOVERY_FRESHNESS_GATE",
        ...
        ("pre_reboot_checkpoint", "status"): "FRESH_READ_ONLY_VERIFIED_OFFHOST_FRESHNESS_GAP",
        ...
        ("pre_reboot_checkpoint", "blocking_reason"): "OFFHOST_RECOVERY_NOT_FRESH_AT_CHECK",
        ...
        ("pre_reboot_checkpoint", "offhost_recovery", "current_day_recovery_present"): False,
        ...
        ("reboot_coordination", "status"): "BLOCKED_OFFHOST_RECOVERY_FRESHNESS_THEN_EXTERNAL_COORDINATION",
        ("reboot_coordination", "checkpoint_refresh_required"): False,
        ("reboot_coordination", "offhost_recovery_freshness_required"): True,
        ("authorization", "pre_reboot_checkpoint"): "FRESH_READ_ONLY_COMPLETED_OFFHOST_FRESHNESS_GAP",
