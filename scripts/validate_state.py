...
def main() -> int:
    ...
    exact = {
        ...
        ("state_classification",): "CURRENT_FINAL_TRANSVERSAL_AUDIT_EXECUTED_REMEDIATION_GATE_NEXT",
        ("documentation_state",): "FINAL_TRANSVERSAL_AUDIT_EXECUTED_REMEDIATION_GATE_NEXT",
        ...
        ("source_snapshot", "main", "sha"): "78a4106aaa7a4cbbe3b6c78525bf7991d05a83a7",
        ("source_snapshot", "main", "latest_integrated_pr"): 53,
        ("project", "integration_status"): "PR51_OPERATIONAL_PR50_PR52_PR53_CANONICAL_INTEGRATED",
        ("project", "status"): "ACTIVE_FINAL_TRANSVERSAL_AUDIT_EXECUTED_REMEDIATION_GATE_NEXT",
        ("project", "next_exact_step"): "HUMAN_GATE_REPOSITORY_HISTORY_SECRET_POLICY_REMEDIATION",
        ...
        ("control_bridge", "g2b", "task_8", "fresh_hosted_ci"): "BLOCKED_BY_PREEXISTING_REACHABLE_HISTORY_SECRET_POLICY",
        ("control_bridge", "g2b", "task_8", "g2b_specific_hosted_lifecycle_reached"): False,
        ...
        ("repository_hygiene", "pr_semantics"): "HISTORICAL_SANITIZATION_LINEAGE",
        ("repository_hygiene", "classification_pr"): 53,
        ("repository_hygiene", "classification_merge_sha"): "78a4106aaa7a4cbbe3b6c78525bf7991d05a83a7",
        ("repository_hygiene", "remote_branch_count"): 68,
        ("repository_hygiene", "live_remote_branch_count"): 70,
        ("repository_hygiene", "prepublication_audit_branch_count"): 69,
        ("repository_hygiene", "live_integrated_in_main_count"): 18,
        ...
        ("toolchain", "hosted_canonical_latest_run"): 34068890016,
        ("final_transversal_audit", "status"): "EXECUTED_REMEDIATION_PREPARED",
        ("final_transversal_audit", "live_remote_branch_count"): 70,
        ("final_transversal_audit", "prepublication_audit_branch_count"): 69,
        ("final_transversal_audit", "historical_hygiene_snapshot_branch_count"): 68,
        ("final_transversal_audit", "branch_deletions"): 0,
        ("final_transversal_audit", "g2b_pr21"): "DRAFT_UNINTEGRATED_FRESH_HOSTED_CI_BLOCKED_BY_HISTORY_SECRET_POLICY",
        ("final_transversal_audit", "sentinelx_direct"): "INTERMITTENT_NOT_CLOSED_SERVICE_ACTIVE",
        ("final_transversal_audit", "capsule"): "RECONSTRUCTED_FROM_CURRENT_STATE_PENDING_MERGE",
        ("final_transversal_audit", "capability_registry"): "SOURCE_OF_TRUTH_MCF_MAIN_0825BBC",
        ("final_transversal_audit", "mcf_main_sha"): "0825bbcfa1c9e8a07c08d9ff7d9ecbcc51186b22",
        ("final_transversal_audit", "mcf_repository_mutated"): False,
        ...
        ("authorization", "final_transversal_audit"): "AUTHORIZED_EXECUTED_REMEDIATION_PREPARED",
        ("authorization", "g2b_pr21_hosted_requalification"): "AUTHORIZED_EXECUTED_BLOCKED_BY_HISTORY_SECRET_POLICY",
        ("authorization", "cross_repo_capsule_reconciliation"): "AUTHORIZED_PREPARED_CLOUD_ONLY_NO_MCF_MUTATION",
        ("authorization", "destructive_history_remediation"): "NOT_AUTHORIZED",
