...
def main() -> int:
    ...
    exact = {
        ...
        ("documentation_state",): "PRE_REBOOT_ACTIVE_CONSUMERS_COORDINATED_UPDATE_REBOOT_GATE_PENDING",
        ...
        ("project", "next_exact_step"): "HUMAN_GATE_UPDATE_REBOOT",
        ...
        ("reboot_coordination", "status"): "ACTIVE_CONSUMERS_COORDINATED_HUMAN_GATE",
        ...
        ("reboot_coordination", "maintenance_window_status"): "HUMAN_GATE_PENDING",
