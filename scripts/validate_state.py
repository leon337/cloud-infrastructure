...
def main() -> int:
    ...
    exact = {
        ...
        ("documentation_state",): "LIVE_STATE_RECONCILED_OPEN_GOVERNANCE_DEBT",
        ...
        ("project", "next_exact_step"): "PRE_REBOOT_CHECKPOINT_REFRESH_AND_EXTERNAL_SERVICE_COORDINATION_GATE",
        ...
        ("pre_reboot_checkpoint", "status"): "HISTORICAL_VERIFIED_REFRESH_REQUIRED",
        ("pre_reboot_checkpoint", "accepted_for_current_reboot"): False,
        ("pre_reboot_checkpoint", "refresh_required_before_reboot"): True,
        ...
        ("reboot_coordination", "status"): "HUMAN_GATE_AND_EXTERNAL_SERVICE_COORDINATION_REQUIRED",
