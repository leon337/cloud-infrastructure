...
- `PUC-v1.md` — protocolo universal de continuidade.
- `AI-STARTUP-CHECKLIST.md` — gate obrigatório para nova IA.
- `SESSION-CLOSE-CHECKLIST.md` — fechamento sem perda de contexto.
- `CONTINUITY-TEST.md` — teste formal de retomada em novo chat.
- `CONTEXT-COVERAGE.md` — matriz de cobertura/ownership.
